...
export function ResultsView({ analysis, previewUrl, onScanAgain }: ResultsViewProps) {
  ...
  return (
    <div className="results-shell">
      {/* Header */}
      <header className="sticky top-0 z-sticky flex items-center gap-4 px-5 py-4 bg-white border-b border-[#E2E8F0] safe-area-top">
        <img
          src={previewUrl}
          alt="Photo of scanned food"
          className="w-14 h-14 rounded-2xl object-cover border border-[#E2E8F0] flex-shrink-0"
        />
        <div className="flex-1 min-w-0">
          <img src={BitesAILogo} alt="" className="w-5 h-5 rounded object-cover mb-1" aria-hidden="true" />
          <h2 className="text-[#0F172A] text-base font-bold leading-tight truncate">Nutrition Analysis</h2>
          <span
      ...
      {/* Health rating */}
      <div className="mx-4 mb-4 p-4 bg-white border border-[#E2E8F0] rounded-2xl animate-fadeUp md:mx-6 md:mb-5 md:p-5 lg:mx-[2.5rem] lg:mb-6 lg:p-6">
      ...
      {/* Macros */}
      <section className="mx-4 mb-4 md:mx-6 md:mb-5 lg:mx-[2.5rem] lg:mb-6 animate-fadeUp animate-delay-100">
      ...
      {/* Food categories */}
      <section className="mx-4 mb-4 md:mx-6 md:mb-5 lg:mx-[2.5rem] lg:mb-6 animate-fadeUp animate-delay-200">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-8 h-8 flex items-center justify-center bg-blue-600 text-white rounded-lg flex-shrink-0" aria-hidden="true">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {healthInsight.tips.length > 0 && (
        <section className="mx-4 mb-4 md:mx-6 md:mb-5 lg:mx-[2.5rem] lg:mb-6 animate-fadeUp animate-delay-300">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-8 h-8 flex items-center justify-center bg-blue-600 text-white rounded-lg flex-shrink-0" aria-hidden="true">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Notes */}
      {notes && (
        <p className="mx-4 mb-4 px-4 py-3 bg-slate-50 rounded-xl text-sm text-slate-600 leading-relaxed border-l-4 border-blue-600 md:mx-6 md:mb-5 lg:mx-[2.5rem] lg:mb-6">
          {notes}
        </p>
      )}

      {/* Scan again */}
      <div className="px-4 pt-2 pb-6 safe-area-bottom md:px-6 lg:px-[2.5rem]">
        <button
          type="button"
          onClick={onScanAgain}
          className="w-full flex items-center justify-center gap-2 min-h-14 px-6 bg-blue-600 text-white rounded-xl font-semibold text-base transition-all duration-150 hover:-translate-y-0.5 hover:shadow-lg active:scale-[0.97] active:bg-blue-700 lg:min-h-[60px]"
        >
