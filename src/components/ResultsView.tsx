  ...
  return (
    <div className="results-shell">
      <div className="results-layout">
        <div className="results-desktop-grid">
          ...
          <div className="results-panel-photo">
            ...
            {/* Scan Again — left panel (always visible) */}
          ...
          <div className="results-panel-data">
            ...
            {/* Macros Card */}
            <div className="macros-card animate-fadeUp animate-delay-100">
            ...
            {/* Food Classification */}
            <div className="food-section animate-fadeUp animate-delay-300">
            ...
            {/* Notes */}
            {notes && (
              <p className="results-notes animate-fadeUp animate-delay-400">
                {notes}
              </p>
            )}
          </div>
